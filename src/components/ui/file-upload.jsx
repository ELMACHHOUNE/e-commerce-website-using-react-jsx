...
export default function FileUpload({ value, onChange, accept = "image/*", className }) {
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-slate-200 bg-slate-50 p-6 text-center transition-colors hover:bg-slate-100",
